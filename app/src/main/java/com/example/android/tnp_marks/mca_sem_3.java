...
public class mca_sem_3 extends AppCompatActivity {
    EditText cre_4_1, cre_4_2, cre_4_3, cre_4_4, cre_4_5, cre_1_2,cre_1_4, cre_1_1, cre_1_3, cre_1_5;
    int c_4_1, c_4_2, c_4_3, c_4_4, c_4_5,  c_2_1, c_2_2, c_1_1, c_1_2 ,sum, perc, sum_c, perc_c, c_1_3, c_1_5, c_1_4, total = 1000, total_c = 25 ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mca_sem_3);
        ...
        b.setOnClickListener(new View.OnClickListener() {
                                 public void onClick(View v) {
                                     ...
                                     else if(cre_1_5.getText().toString().isEmpty() || Integer.parseInt(cre_1_5.getText().toString()) > 100 )
                                     {
                                         ...
                                         sum = c_4_1 + c_4_2 + c_4_3 + c_4_4 + c_4_5 + c_1_1 + c_1_2 + c_1_3 + c_1_4 + c_1_5;
                                         perc = (sum * 100) / total;
                                         c_4_1 *= 4;
                                         c_4_2 *= 4;
                                         c_4_3 *= 4;
                                         c_4_4 *= 4;
                                         c_4_5 *= 4;
                                         sum_c = c_1_1 + c_1_2 + c_1_3+  c_1_4 + c_1_5 + c_4_1 + c_4_2 + c_4_3 + c_4_4 + c_4_5;
