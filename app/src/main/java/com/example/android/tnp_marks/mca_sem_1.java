...
public class mca_sem_1 extends AppCompatActivity {
    EditText cre_4_1, cre_4_2, cre_4_3, cre_4_4, cre_4_5, cre_2, cre_1_3, cre_1_1, cre_1_2;
    int c_4_1, c_4_2, c_4_3, c_4_4, c_4_5, c_2_1, c_2_2, c_1_1, c_1_2, sum, perc, sum_c, perc_c, c_2, c_1_3, total = 900, total_c = 25;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mca_sem_1);
        ...
        b.setOnClickListener(new View.OnClickListener() {
                                 public void onClick(View v) {
                                     ...
                                     if (cre_4_1.getText().toString().isEmpty() || Integer.parseInt(cre_4_1.getText().toString()) > 100) {
                                         ...
                                         sum = c_4_1 + c_4_2 + c_4_3 + c_4_4 + c_4_5 + c_1_3 + c_2 + c_1_1 + c_1_2;
                                         perc = (sum * 100) / total;
                                         c_4_1 *= 4;
                                         c_4_2 *= 4;
                                         c_4_3 *= 4;
                                         ...
                                         c_2_1 *= 2;
                                         c_2_2 *= 2;
                                         sum_c = c_1_1 + c_1_2 + c_2_1 + c_4_1 + c_4_2 + c_4_3 + c_4_4 + c_4_5 + c_2_2;
                                         perc_c = sum_c / total_c;
                                         tv.setText("Without credits :- " + "Total = " + Integer.toString(sum) + "  Percentage = " + Integer.toString(perc));
                                         tv2.setText("Total credits :- 25 Total credits :- Credits Gained :- " + Integer.toString(total_c));
