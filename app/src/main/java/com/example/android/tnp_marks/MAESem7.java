...
public class MAESem7 extends AppCompatActivity {


    EditText cre_4_1, cre_4_2, cre_4_3, cre_4_4,cre_1_1,cre_1_2,cre_2,cre_3,cre_1_3,cre_1_4,cre_6;
    int c_4_1, c_4_2, c_4_3, c_4_4,c_1_1,c_1,c_2,c_3,c_1_4,c_1_3,c_1_2, sum, perc, sum_c, perc_c, total = 1000, total_c = 25 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
                                 public void onClick(View v) {
                                     ...
                                     cre_3 = (EditText) findViewById(R.id.ed4);
                                     cre_1_1 = (EditText) findViewById(R.id.ed5);
                                     cre_1_2 = (EditText) findViewById(R.id.ed6);
                                     cre_1_3 = (EditText) findViewById(R.id.ed7);
                                     cre_4_4 = (EditText) findViewById(R.id.ed8);
                                     cre_2 = (EditText) findViewById(R.id.ed9);
                                     cre_1_4 = (EditText) findViewById(R.id.ed10);
                                     if (cre_4_1.getText().toString().isEmpty() || Integer.parseInt(cre_4_1.getText().toString()) > 100) {
                                         ...
                                         sum = c_4_1 + c_4_2 + c_4_3 + c_4_4+c_1_1+ c_1_2 + c_1_3 + c_1_4 + c_2 + c_3;
                                         perc = (sum * 100) / total;
                                         c_4_1 *= 4;
                                         c_4_2 *= 4;
                                         c_4_3 *= 4;
                                         ...
                                         sum_c =  c_4_1 + c_4_2 + c_4_3 + c_4_4+c_1_1+ c_1_2 + c_1_3 + c_1_4 + c_2 + c_3;
