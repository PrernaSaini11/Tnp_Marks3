...
public class mca_sem_6 extends AppCompatActivity {
    EditText cre1, cre2;
    int i1, i2, sum, prec, sum_c, prec_c, total = 200, total_c = 30;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mca_sem_6);
        ...
        b.setOnClickListener(new View.OnClickListener() {
                                 public void onClick(View v) {
                                     if (cre1.getText().toString().isEmpty() || Integer.parseInt(cre1.getText().toString()) > 100) {
                                         ...
                                         tv2.setText("Total credits :- 30 Credits Gained :- " + Integer.toString(total_c));
